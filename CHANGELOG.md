...
- Syntax: added support for $meta_branch_remap(name) and $meta_branch(name) functions for views TF patterns. See [Wiki](https://wiki.hydrogenaudio.org/index.php?title=Foobar2000:Titleformat_Album_List).
