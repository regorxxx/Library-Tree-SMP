...
function getSoFeatures() {
	...
	const paths = ['Program Files\\Internet Explorer\\ieinstal.exe', 'Program Files (x86)\\Internet Explorer\\ieinstal.exe', 'Program Files\\Internet Explorer\\iexplore.exe', 'Program Files (x86)\\Internet Explorer\\iexplore.exe'];
